...
rgb_train = np.load("./res/nsl/RGB_TRAIN.npz")["patches"]
rgb_test = np.load("./res/nsl/RGB_TEST.npz")["patches"]

att_train = np.load("./res/nsl/IM.npz")["patches"]
att_test = np.load("./res/nsl/IM_TEST.npz")["patches"]
